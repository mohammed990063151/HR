    ...
    <!-- Page Wrapper -->
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_training"><i class="fa fa-plus"></i> إضافة جديد </a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item edit_training" href="#" data-toggle="modal" data-target="#edit_training"><i class="fa fa-pencil m-r-5"></i> تعديل</a>
                                                <a class="dropdown-item delete_training" href="#" data-toggle="modal" data-target="#delete_training"><i class="fa fa-trash-o m-r-5"></i> حذف</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">إضافة تدريب جديد</h5>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">نوع التدريب</label>
                                        <select class="select" name="training_type" @error('training_type') is-invalid @enderror>
                                            <option selected disabled>-- Select --</option>
                                            <option value="Node Training">تدريب العقدة</option>
                                            <option value="Swift Training">تدريب Swift</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">مدرب</label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">الموظفون</label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">تكلفة التدريب <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="training_cost" @error('training_cost') is-invalid @enderror>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>بداية التاريخ <span class="text-danger">*</span></label>
                                        <div class="cal-icon">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>نهاية التاريخ <span class="text-danger">*</span></label>
                                        <div class="cal-icon">
        ...
        <div id="edit_training" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">تعديل قائمة التدريب</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('form/training/update') }}" method="POST">
                            ...
                            <div class="submit-section">
                                <button type="submit" class="btn btn-primary submit-btn">التحديث</button>
                            </div>
                        </form>
                    </div>
                </div>
