    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">إنشاء تقدير</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">لوحة التحكم</a></li>
                            <li class="breadcrumb-item active">إنشاء تقدير</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <form action="{{ route('create/estimate/save') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="select" id="client" name="client">
                                        <option> --الرجاء اختيار-- </option>
                                        <option value="Barry Cuda">باري كودا</option>
                                        <option value="Tressa Wexler">تريسا ويكسلر</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="select" id="project" name="project">
                                        ...
                                        <option value="Office Management">إدارة المكتب</option>
                                        <option value="Project Management">إدارة المشروع</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="select" id="tax" name="tax">
                                        ...
                                        <option value="No Tax">لا توجد ضريبة</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    <label>تاريخ التقدير <span class="text-danger">*</span></label>
                                    <div class="cal-icon">
                        ...
                        <div class="submit-section">
                            <button class="btn btn-primary submit-btn m-r-10">حفظ وإرسال</button>
