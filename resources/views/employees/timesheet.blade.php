    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">الجدول الزمني</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_todaywork"><i class="fa fa-plus"></i> إضافة عمل اليوم</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>التاريخ</th>
                                    <th>المشاريع</th>
                                    <th class="text-center">الساعات المخصصة</th>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html">mohammed mustafa <span>Web Designer</span></a>
                                        </h2>
                                    </td>
                                    <td>8 Mar 2019</td>
                                    <td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">أضف تفاصيل عمل اليوم</h5>
                        ...
                        <form>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <select class="select">
                                        <option>إدارة المكتب</option>
                                        <option>إدارة المشاريع</option>
                                        <option>تطبيق المكالمات الفيديو</option>
                                        <option>إدارة المستشفى</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    <label>موعد التسليم <span class="text-danger">*</span></label>
                                    <div class="cal-icon">
                                        <input class="form-control" type="text" value="5 May 2019" readonly>
                                    </div>
                                </div>
                                <div class="form-group col-sm-4">
                                    <label>إجمالي الساعات <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" value="100" readonly>
                                </div>
                                <div class="form-group col-sm-4">
                                    <label>الساعات المتبقية <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    <label>الساعات <span class="text-danger">*</span></label>
        ...
        <div id="edit_todaywork" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">تعديل تفاصيل العمل</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
