                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">الجدولة اليومية</li>
                        </ul>
                    </div>
                ...
                <div class="col-sm-6 col-md-3"> 
                    <div class="form-group form-focus select-focus">
                        <select class="select floating"> 
                            ...
                            <option value="1">المحاسبة</option>
                            <option value="2">المحاسبة والإدارة</option>
                            <option value="3">الموارد البشرية والمحاسبة</option>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html">ضياء الدين خالد
                                                  <span>Web Developer</span></a>
                                        </h2>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html"> ناصرالدين خالد
                                                 <span>Web Developer</span></a>
                                        </h2>
                                    </td>
                                    <td>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">قسم
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">التحولات
                                             <span class="text-danger">*</span></label>
                                        <select class="select">
                                            <option value="">اختار التحولات
                                                 </option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-form-label">الحد الأدنى لوقت البدء  <span class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-form-label">الحد الأقصى لوقت البدء  <span class="text-danger">*</span></label>
                                        <div class="input-group time timepicker">
                                            <input class="form-control"><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-form-label">الحد الأقصى لوقت الانتهاء  <span class="text-danger">*</span></label>
                                        <div class="input-group time timepicker">
                                            <input class="form-control"><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">
                                            ...
                                            <span class="text-danger">*</span></label>
                                        <select class="select">
                                            <option value="">اختار الشيفت</option>
                                            <option value="1">10'o clock Shift</option>
                                            <option value="2">10:30 shift</option>
                                            <option value="3">Daily Shift </option>
                                ...
                                <div class="col-sm-12">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="customCheck1">تكرار التوقيت</label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <label class="col-form-label">أسبوع(s)</label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
