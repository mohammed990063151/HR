            ...
            <div class="page-header">
                <div class="row align-lists-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_employee"><i class="fa fa-plus"></i> اضافة موظف </a>
                ...
                <div class="row filter-row">
                    <div class="col-sm-6 col-md-3">  
                        <div class="form-group form-focus">
                            ...
                            <label class="focus-label"> رقم التعريفي لموظف</label>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">  
                        <div class="form-group form-focus">
                    ...
                    <div class="col-sm-6 col-md-3">  
                        <button type="sumit" class="btn btn-success btn-block"> البحث</button>  
                    </div>
                </div>
            </form>
            <!-- Search Filter -->
                    ...
                    <div class="modal-body">
                        <form action="{{ route('all/employee/save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">الايميل <span class="text-danger">*</span></label>
