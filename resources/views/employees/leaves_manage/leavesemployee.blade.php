    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">أوراق <span id="year"></span></h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">لوحة التحكم</a></li>
                            <li class="breadcrumb-item active">أوراق الاجازات</li>
                        </ul>
                    </div>
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_leave"><i class="fa fa-plus"></i> إضافة عطل</a>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th hidden>ID</th>
                                    <th>نوع الإجازة</th>
                                    <th hidden>الإجازات المتبقية</th>
                                    <th>من</th>
                                    <th>الى</th>
                                    <th>عدد الأيام</th>
                                    <th hidden>عدد الأيام</th>
                                    <th hidden>تاريخ المغادرة</th>
                                    <th hidden>يوم الإجازة</th>
                                    <th>السبب</th>
                                    <th class="text-center">حالة الإجازة</th>
                                        ...
                                        <td class="text-center">
                                            <div class="action-label">
                                                <a class="btn btn-white btn-sm btn-rounded" href="javascript:void(0);">
                                                    <i class="fa fa-dot-circle-o text-warning"></i> قيد الانتظار
                                                </a>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item edit_leave" href="#" data-toggle="modal" data-target="#edit_leave"><i class="fa fa-pencil m-r-5"></i> تعديل</a>
                                                    <a class="dropdown-item delete_leave" href="#" data-toggle="modal" data-target="#delete_approve"><i class="fa fa-trash-o m-r-5"></i> حذف</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">أضف إجازة</h5>
                    ...
                    <div class="modal-body">
                        <form class="applyLeave" action="{{ route('form/leaves/save') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" id="leave_type" name="leave_type">
                                            <option selected disabled>اختر نوع الإجازة</option>
                                            @foreach($leaveInformation as $key => $leaves)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>الأوراق المتبقية<span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div id="leave_day_select" class="col-md-12">
                                    <div class="form-group">
                                        <label>نوع يوم الإجازة <span class="text-danger">*</span></label>
                                        <select class="select" name="select_leave_day[]" id="leave_day">
                                            <option value="Full-Day Leave">إجازة يوم كامل</option>
                                            <option value="Half-Day Morning Leave">إجازة نصف يوم صباح</option>
                                            <option value="Half-Day Afternoon Leave">إجازة نصف يوم مساء</option>
                                            <option value="Public Holiday">عطلة عامة</option>
                                            <option value="Off Schedule">غير مجدول</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>سبب الإجازة <span class="text-danger">*</span></label>
                                <textarea rows="2" class="form-control" name="reason"></textarea>
                            </div>
                           
                            <div class="submit-section">
                                <button type="submit" id="apply_leave" class="btn btn-primary submit-btn">ارسال</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div id="edit_leave" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">تعديل الإجازة</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <form action="{{ route('form/leaves/save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label>الإجازات المتبقية <span class="text-danger">*</span></label>
                            ...
                            <div class="submit-section">
                                <button type="submit" class="btn btn-primary submit-btn" id="e_apply_leave">حفظ</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-header">
                            <h3>حذف الاجازة</h3>
                            <p>هل أنت متأكد من إلغاء هذه الإجازة؟</p>
                        </div>
