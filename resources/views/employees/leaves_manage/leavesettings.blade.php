    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">اعدادات الاجازات</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">لوحة التحكم</a></li>
                            <li class="breadcrumb-item active">اعدادات الاجازات</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="leave-item">
                                ...
                                <div class="leave-row">
                                    ...
                                    <div class="leave-right">
                                        <button class="leave-edit-btn">تعديل</button>
                                    </div>
                                </div>
                                <!-- /Annual Days Leave -->
                                ...
                                <div class="leave-row">
                                    <div class="leave-left">
                                        <div class="input-box">
                                            <label class="d-block">نقل الاجازة</label>
                                            <div class="leave-inline-form">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="carry_no">لا</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="carry_yes" value="option2" disabled>
                                                    <label class="form-check-label" for="carry_yes">نعم</label>
                                                </div>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">الحد الأقصى</span>
                                                    </div>
                                                    <input type="text" class="form-control" disabled>
                                                </div>
                                            </div>
                            ...
                            <div class="custom-policy">
                                <div class="leave-header">
                                    <div class="title">سياسة مخصصة</div>
                                    <div class="leave-action">
                                        <button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#add_custom_policy"><i class="fa fa-plus"></i> إضافة سياسة مخصصة</button>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover table-nowrap leave-table mb-0">
                                        <thead>
                                            <tr>
                                                <th class="l-name">الاسم</th>
                                                <th class="l-days">الأيام</th>
                                                <th class="l-assignee">المُسنَد</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="#" class="dropdown-item" data-toggle="modal" data-target="#edit_custom_policy"><i class="fa fa-pencil m-r-5"></i> تعديل</a>
                                                            <a href="#" class="dropdown-item" data-toggle="modal" data-target="#delete_custom_policy"><i class="fa fa-trash-o m-r-5"></i> حذف</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <div class="card leave-box" id="leave_maternity">
                        <div class="card-body">
                            <div class="h3 card-title with-switch">
                                إجازة الولادة  <span class="subtitle">مُسنَد فقط للإناث</span>
                                <div class="onoffswitch">
                    ...
                    <div class="card leave-box" id="leave_paternity">
                        <div class="card-body">
                            <div class="h3 card-title with-switch">
                                إجازة الأب  <span class="subtitle">مُسنَد فقط للذكور</span>
                                <div class="onoffswitch">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        <a aria-expanded="false" data-toggle="dropdown" class="action-icon dropdown-toggle" href="#"><i class="material-icons">more_vert</i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="#" class="dropdown-item" data-toggle="modal" data-target="#edit_custom_policy"><i class="fa fa-pencil m-r-5"></i> التعديل</a>
                                                            <a href="#" class="dropdown-item" data-toggle="modal" data-target="#delete_custom_policy"><i class="fa fa-trash-o m-r-5"></i> حذف</a>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">إضافة سياسة مخصصة</h5>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                <label>اسم خصوصية <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-sm-5">
                                        <select name="customleave_from" id="customleave_select" class="form-control" size="5" multiple="multiple">
                                            <option value="1">محمد مصطفى  </option>
                                            <option value="2">اشرف </option>
                                            <option value="2">عمر </option>
                                        </select>
                                    </div>
        ...
        <div id="edit_custom_policy" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">تعديل سياسة مخصصة</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <label>يومي <span class="text-danger">*</span></label>
