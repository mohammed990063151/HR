    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="stats-info">
                        <h6>الإجازات المخطط لها</h6>
                        <h4>8 <span>اليوم</span></h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-info">
                        <h6>إجازات غير مخطط لها</h6>
                        <h4>0 <span>اليوم</span></h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-info">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">  
                    <div class="form-group form-focus select-focus">
                        <select class="select floating"> 
                            ...
                            <option>الإجازة الطبية</option>
                            <option>فقدان الأجر</option>
                        </select>
                        <label class="focus-label">نوع الإجازة</label>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12"> 
                    <div class="form-group form-focus select-focus">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">إضافة إجازة</h5>
                        ...
                        <form class="applyLeave" action="{{ route('form/leaves/save') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" id="leave_type" name="leave_type">
                                            <option selected disabled>حدد نوع الإجازة</option>
                            ...
                            <div class="row">
                                <div id="leave_day_select" class="col-md-12">
                                    <div class="form-group">
                                        <label>يوم الإجازة <span class="text-danger">*</span></label>
                                        <select class="select" name="select_leave_day[]" id="leave_day">
                                            <option value="Full-Day Leave"> إجازة ليوم كامل</option>
                            ...
                            <div class="form-group">
                                <label> ترك السبب<span class="text-danger">*</span></label>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-header">
                            <h3>الموافقة على الإجازة</h3>
                            <p>هل أنت متأكد أنك تريد الموافقة على هذه الإجازة؟</p>
                        </div>
                        <div class="modal-btn delete-action">
                            <div class="row">
                                <div class="col-6">
                                    <a href="javascript:void(0);" class="btn btn-primary continue-btn">يعتمد</a>
                                </div>
                                <div class="col-6">
                                    <a href="javascript:void(0);" data-dismiss="modal" class="btn btn-primary cancel-btn">رفض</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-header">
                            <h3>حذف الإجازة</h3>
                            <p>هل أنت متأكد أنك تريد حذف هذه الإجازة؟</p>
                        </div>
                        <div class="modal-btn delete-action">
