    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">تقرير الحضور</h3>
                        <ul class="breadcrumb">
            ...
            <div class="row filter-row">
                ...
                <div class="col-sm-6 col-md-3">  
                    <div class="form-group form-focus">
                        ...
                        <label class="focus-label">شهور</label>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">  
                    <div class="form-group form-focus">
                        ...
                        <label class="focus-label">السنوات</label>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">  
                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>4</td>
                                    <td>4 Jan 2020</td>
                                    <td colspan="3" class="text-danger text-center">عطلة نهاية الأسبوع</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>5 Jan 2020</td>
