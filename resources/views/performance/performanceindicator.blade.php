    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">مؤشر الأداء</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">لوحة التحكم</a></li>
                            <li class="breadcrumb-item active">مؤشر الأداء</li>
                        </ul>
                    </div>
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_indicator"><i class="fa fa-plus"></i> إضافة جديد</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item edit_indicator" href="#" data-toggle="modal" data-target="#edit_indicator"><i class="fa fa-pencil m-r-5"></i> تعديل</a>
                                                <a class="dropdown-item delete_indicator" href="#" data-toggle="modal" data-target="#delete_indicator"><i class="fa fa-trash-o m-r-5"></i> حذف</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">تحديد مؤشر جديد</h5>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('form/performance/indicator/save') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="select" id="designation" name="designation">
                                            <option selected disabled>--حدد الوظيفة--</option>
                                ...
                                <div class="col-sm-6">
                                    <h4 class="modal-sub-title">اِصطِلاحِيّ</h4>
                                    <div class="form-group">
                                        <label class="col-form-label">تجربة العملاء</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">تسويق</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">إدارة</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">الإدارة الإدارية</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">مهارات العرض</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">جودة العمل</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">الكفاءة</label>
                                ...
                                <div class="col-sm-6">
                                    <h4 class="modal-sub-title">التنظيمية</h4>
                                    <div class="form-group">
                                        <label class="col-form-label">النزاهة</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">المهنية</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">العمل الجماعي</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">التفكير النقدي</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">إدارة النزاعات</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">الحضور</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">القدرة على الالتزام بالمواعيد النهائية</label>
        ...
        <div id="edit_indicator" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">تعديل مؤشر الأداء</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('form/performance/indicator/update') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <h4 class="modal-sub-title">تقني</h4>
                                    <div class="form-group">
                                        <label class="col-form-label">تجربة العملاء</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">إدارة النظام</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">كفاءة العمل</label>
                                        ...
                                        <div class="col-sm-6">
                                    <h4 class="modal-sub-title">تنظيمي</h4>
                                    <div class="form-group">
                                        <label class="col-form-label">النزاهة</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">عمل الفريق</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">إدارة التضارب</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">القدرة على الالتزام بالموعد النهائي</label>
