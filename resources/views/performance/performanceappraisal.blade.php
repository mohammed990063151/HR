    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">تقييم الأداء</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">لوحة التحكم</a></li>
                            <li class="breadcrumb-item active">تقييم الأداء</li>
                        </ul>
                    </div>
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_appraisal"><i class="fa fa-plus"></i> إضافة تقييم جديد</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item edit_appraisal" href="#" data-toggle="modal" data-target="#edit_appraisal"><i class="fa fa-pencil m-r-5"></i> تعديل</a>
                                                <a class="dropdown-item delete_appraisal" href="#" data-toggle="modal" data-target="#delete_appraisal"><i class="fa fa-trash-o m-r-5"></i> حذف</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">إعطاء تقييم الأداء</h5>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="col-form-label">الموظف</label>
                                        <select class="select" id="name" name="name">
                                            <option selected disabled> -- اختار الموظف -- </option>
                                                ...
                                                <div class="row user-tabs">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                                                        <ul class="nav nav-tabs nav-tabs-solid">
                                                            <li class="nav-item"><a href="#appr_technical" data-toggle="tab" class="nav-link active">المهارات التقنية</a></li>
                                                            <li class="nav-item"><a href="#appr_organizational" data-toggle="tab" class="nav-link">المهارات التنظيمية</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="bg-white">
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                      <tr>
                                                                        <th colspan="2">المؤشر</th>
                                                                        <th colspan="2">القيمة المتوقعة</th>
                                                                        <th>القيمة المحددة</th>
                                                                      </tr>
                                                                      <tr>
                                                                        <td colspan="2">تجربة العميل</td>
                                                                      ...
                                                                      <tr>
                                                                        <td colspan="2">إدارة</td>
                                                                        <td colspan="2">متقدم</td>
                                                                        <td>
                                                                      ...
                                                                      <tr>
                                                                        <td colspan="2">مهارات العرض</td>
                                                                        <td colspan="2">متقدم / قائد</td>
                                                                        <td>
                                                            ...
                                                            <div class="bg-white">
                                                                <table class="table">
                                                                    <thead>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2">النزاهة</td>
                                                                            <td colspan="2">مبتدئ</td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2">التفكير النقدي</td>
                                                                            <td colspan="2">متقدم</td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2">إدارة النزاعات</td>
                                                                            <td colspan="2">متوسط</td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2">قدرة على الالتزام بالموعد النهائي</td>
                                                                            <td colspan="2">متقدم</td>
                                                                            <td>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="col-form-label">الحاله</label>
        ...
        <div id="edit_appraisal" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">تعديل تقييم الأداء</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <form action="{{ route('form/performance/appraisal/update') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label>اختر التاريخ <span class="text-danger">*</span></label>
                                        <div class="cal-icon">
                                        ...
                                        <div class="card-body">
                                            <div class="tab-box">
                                                <div class="row user-tabs">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                                                        <ul class="nav nav-tabs nav-tabs-solid">
                                                            <li class="nav-item"><a href="#appr_technical1" data-toggle="tab" class="nav-link active">الكفاءات التقنية</a></li>
                                                            <li class="nav-item"><a href="#appr_organizational1" data-toggle="tab" class="nav-link">الكفاءات التنظيمية</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="bg-white">
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2">القدرة على الالتزام بالمواعيد النهائية</td>
                                                                            <td colspan="2">متقدم</td>
                                                                            <td>
